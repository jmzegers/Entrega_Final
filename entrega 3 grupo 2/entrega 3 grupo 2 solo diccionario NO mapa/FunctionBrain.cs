    ...
    class FunctionBrain
    {
        ...
        public double EdifMarket(string a, double money, Dictionary<string, Dictionary<string, List<int>>> usedCoordinates)
        {
            ...
            if (a == "P") //Plantacion
            {
                ...
                /*foreach(KeyValuePair<string, Dictionary<int, double>> prices in seedHistory)
                {
                    Dictionary<int, double> seed1 = prices.Value;
                    foreach (KeyValuePair<int, double> seeds in seed1)
                    {
                        Console.WriteLine(seeds.Key, seeds.Value);
                    }
                }*/
